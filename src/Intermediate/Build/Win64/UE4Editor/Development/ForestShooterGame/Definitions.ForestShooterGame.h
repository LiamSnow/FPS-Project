...
#define ORIGINAL_FILE_NAME "UE4Editor-ForestShooterGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ForestShooterGame
#define DEPRECATED_FORGAME DEPRECATED
#define FORESTSHOOTERGAME_API DLLEXPORT
